        ...
        (should
         (equal
          (xr-lint "%\\|[abc]\\|[[:digit:]]\\|\\s-\\|\\s_"
                   nil checks)
          (if (eq checks 'all)
              '((0 7 "Or-pattern more efficiently expressed as character alternative")
                (3 20 "Or-pattern more efficiently expressed as character alternative")
                (10 25 "Or-pattern more efficiently expressed as character alternative"))
            nil)))
        ))))
